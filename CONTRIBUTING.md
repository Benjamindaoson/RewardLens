...
Thank you for improving **RewardLens**.
...
- repository tests and configuration validation
- protocol, manifest, and checksum consistency
- no empirical claim without an observed run artifact
