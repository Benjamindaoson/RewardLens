...
ranking of multimodal judges. Programmatic checks validate the rendered scene
contracts but are not a substitute for human perceptual validation. Candidate
order is held fixed within each triplet; because an orientation-swap audit is
not part of the reported experiment, RA and II are estimates under this frozen
pair orientation rather than position-bias-free quantities.
